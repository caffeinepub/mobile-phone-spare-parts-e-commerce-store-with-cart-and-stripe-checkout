...
import type { Order as _Order, OrderStatus as _OrderStatus, ShoppingItem as _ShoppingItem, StripeSessionStatus as _StripeSessionStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async archiveProduct(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async recordOrder(arg0: string, arg1: Array<ShoppingItem>, arg2: bigint, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordOrder(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
